    ...
    <article className="section-gap px-6">
      <div className="mx-auto max-w-[1200px]">
        ...
        <p className="text-[hsl(var(--muted))] mb-10">
          All projects beyond the three flagships.
        </p>
            ...
            {filtered.map((project) => (
              ...
              >
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-xs font-[family-name:var(--font-mono)] text-[hsl(var(--muted))]">
                    {project.period}
                  </span>
                </div>
                ...
                <p className="text-xs text-[hsl(var(--muted))] leading-relaxed line-clamp-3 mb-3">
                  {project.description}
                </p>
